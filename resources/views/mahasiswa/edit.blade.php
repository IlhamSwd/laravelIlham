      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <select name="prodi_id" id="prodi_id" class="form-control" name="prodi_id" value="{{ old('prodi_id') ? old('prodi_id') : $mahasiswa["prodi_id"] }}" placeholder="Masukan Prodi">
            ...
            <div class="form-group">
              ...
              <input type="file" class="form-control" name="url_foto" name="url_foto" value="{{ old('url_foto') ? old('url_foto') : $mahasiswa["url_foto"] }}" placeholder="url_foto">
              @Error('url_foto')
                  <span class="text-danger">{{$message}}</span>
              @enderror
            </div>
